        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-3xl text-center">
          <motion.div {...fadeUp}>
            ...
            <p className="mt-6 text-muted-foreground text-lg leading-relaxed max-w-2xl mx-auto">
              Tell us about your situation. This helps us identify the most relevant assessment path and connect you with the right strategic support.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="bg-card rounded-2xl p-6 lg:p-8 shadow-soft border border-border/40 space-y-5">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="full_name" value={form.full_name} onChange={(e) => updateField("full_name", e.target.value)} maxLength={100} className={fieldClass("full_name")} placeholder="Dr. Jane Smith" />
                  {errors.full_name && <p className="text-xs text-destructive">{errors.full_name}</p>}
                </div>
                <div className="space-y-2">
                  <Label htmlFor="organization_name">Clinic / Organization Name</Label>
                  <Input id="organization_name" value={form.organization_name} onChange={(e) => updateField("organization_name", e.target.value)} maxLength={150} placeholder="e.g. Summit Medical Clinic" />
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="email" type="email" value={form.email} onChange={(e) => updateField("email", e.target.value)} maxLength={255} className={fieldClass("email")} placeholder="jane@example.com" />
                  {errors.email && <p className="text-xs text-destructive">{errors.email}</p>}
                </div>
                <div className="space-y-2">
                  <Label htmlFor="phone">Phone</Label>
                  <Input id="phone" value={form.phone} onChange={(e) => updateField("phone", e.target.value)} maxLength={30} className={fieldClass("phone")} placeholder="(403) 555-0100" />
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="city" value={form.city} onChange={(e) => updateField("city", e.target.value)} maxLength={80} placeholder="Calgary" />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="country" value={form.country} onChange={(e) => updateField("country", e.target.value)} maxLength={60} />
                </div>
              </div>
            </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={form.practice_type} onValueChange={(v) => updateField("practice_type", v)}>
                    ...
                    <SelectContent>
                      {practiceTypeOptions.map((t) => <SelectItem key={t} value={t}>{t}</SelectItem>)}
                    </SelectContent>
                  </Select>
                </div>
              </div>
