    ...
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-28 bg-gradient-hero">
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="mt-8 text-lg text-muted-foreground leading-relaxed max-w-3xl">
            Opening a medical clinic, dental practice, or veterinary facility in Alberta involves regulatory requirements, financial planning, and operational decisions that most practitioners have not navigated before. Start with a <Link to="/strategic-assessment" className="text-primary hover:text-foreground underline underline-offset-2 transition-colors">strategic assessment</Link> to understand where you stand. Our <Link to="/about" className="text-primary hover:text-foreground underline underline-offset-2 transition-colors">clinician-led team</Link> has supported more than 15 facility builds — and across those engagements, we have developed a clear picture of where early decisions tend to have the greatest long-term impact. We work alongside you through the planning process, helping you avoid common pitfalls and build a structure that supports how you want to practice. And <Link to="/solutions/existing-clinics" className="text-primary hover:text-foreground underline underline-offset-2 transition-colors">as your practice grows</Link>, we continue to support operations and optimization.
          </motion.p>
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
          <div className="mb-16">
            ...
            <h2 className="font-display text-3xl lg:text-4xl font-bold text-foreground">From concept to opening day.</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {developmentStages.map((stage, i) => (
              <motion.div key={stage.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} className="bg-card rounded-2xl p-6 shadow-soft border border-border/40 hover:shadow-card transition-shadow duration-300">
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {partners.map((partner, i) => (
              <motion.div key={partner.label} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.06 }} className="bg-card rounded-xl p-5 shadow-soft border border-border/40 text-center">
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container mx-auto px-4 lg:px-8 max-w-5xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-card rounded-2xl p-8 lg:p-12 shadow-card border border-border/40">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <h2 className="font-display text-3xl lg:text-4xl font-bold text-foreground mb-4">Non-Hospital Surgical Facilities</h2>
                <p className="text-muted-foreground leading-relaxed">NHSF development requires specialized planning that differs from traditional practice development. These facilities face unique regulatory, operational, and design requirements.</p>
              </div>
              <div className="space-y-4">
                {[
                  { t: "Regulatory Considerations", d: "Navigating licensing, accreditation, and compliance requirements specific to surgical facilities." },
                  { t: "Facility Design Coordination", d: "Ensuring facility layout meets surgical standards while supporting efficient workflows." },
                  { t: "Technology Planning", d: "Integrating surgical equipment, monitoring systems, and clinical technology infrastructure." },
                  { t: "Operational Systems", d: "Designing workflows for patient preparation, surgical procedures, and post-operative care." },
                ].map((item) => (
                  <div key={item.t} className="bg-secondary/30 rounded-xl p-4">
      ...
      <section className="py-20 lg:py-28 bg-gradient-section">
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="font-display text-3xl lg:text-4xl font-bold text-foreground mb-6">Thinking about opening a new practice?</h2>
            <p className="text-muted-foreground text-lg leading-relaxed mb-8 max-w-2xl mx-auto">Explore a strategic assessment to understand your opportunity, identify key considerations, and outline the path forward.</p>
