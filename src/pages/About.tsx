    ...
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-28 bg-gradient-hero">
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="mt-8 text-lg text-muted-foreground leading-relaxed max-w-3xl">
            Based in Calgary, Vitalis Health Strategies works with practitioners and healthcare organizations across Canada to design, launch, and optimize successful practices. We act as both strategic advisor and coordination partner across the full lifecycle of healthcare ventures.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-14">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <p className="mt-6 text-muted-foreground leading-relaxed">
                Healthcare projects often involve architects, lenders, legal advisors, technology partners, consultants, and regulatory considerations. We work alongside clients to coordinate these moving parts so practitioners and practice leaders are not left managing fragmented decisions on their own.
              </p>
              <p className="mt-4 text-muted-foreground leading-relaxed">
                Our approach combines healthcare consulting expertise with practical execution support — from concept planning through long-term improvement for organizations across Canada.
              </p>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
              ...
              <ul className="mt-6 space-y-4 text-muted-foreground">
                {[
                  ...
                  "Practitioner-centered planning grounded in operational reality",
        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {threePillars.map((pillar, i) => (
              <motion.div key={pillar.title} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }} className="bg-card rounded-2xl p-8 shadow-soft border border-border/40 text-center">
