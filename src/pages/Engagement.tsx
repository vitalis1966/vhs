    ...
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-28 bg-gradient-hero">
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-accent font-medium tracking-widest uppercase text-sm mb-6">Engagement Model</motion.p>
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container mx-auto px-4 lg:px-8 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl mx-auto">Clear phases, clear decisions, and practical guidance from initial planning through ongoing advisory support.</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-8">
            {phases.map((phase, i) => (
              <motion.div key={phase.phase} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }} className="bg-card rounded-2xl p-8 shadow-soft hover:shadow-card transition-all duration-300 border border-border/40">
      ...
      <section className="py-20 lg:py-28 bg-gradient-section">
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl text-center">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">While some clients engage for specific projects, many retain Vitalis for ongoing strategic advisory. This continuity helps maintain alignment as organizations scale, adapt, and pursue new opportunities across Calgary and Canada.</p>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-10">Start with a strategic conversation and determine the right pathway for your organization.</p>
