...
import { ArrowRight, ClipboardList, DollarSign, Building2, Shield, FileText, Users, Settings, BarChart2, RefreshCw, MapPin, Eye, Bone, Microscope, Scissors, Baby, Activity, Stethoscope, Smile, Zap, Brain, CheckCircle, PawPrint } from "lucide-react";
import "react";
...
function NHSF() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsx(JsonLd, { data: buildServiceSchema("Non-Hospital Surgical Facility Consulting", "Advisory and consulting for NHSF and surgical facility planning, licensing, operations, and compliance.", "/solutions/nhsf") }),
    /* @__PURE__ */ jsx(JsonLd, { data: buildBreadcrumbSchema([{ name: "Home", path: "/" }, { name: "Solutions", path: "/solutions" }, { name: "Surgical Facilities", path: "/solutions/nhsf" }]) }),
    /* @__PURE__ */ jsx(Navbar, {}),
    /* @__PURE__ */ jsxs("main", { children: [
      /* @__PURE__ */ jsx("section", { className: "pt-32 pb-20 lg:pt-40 lg:pb-28 bg-gradient-hero", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 lg:px-8 max-w-5xl text-center", children: [
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 mb-4", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-accent font-semibold tracking-widest uppercase text-sm", children: "Non-Hospital Surgical Facilities" })
          ] }),
          /* @__PURE__ */ jsx("h1", { className: "font-display text-3xl lg:text-5xl font-bold text-foreground tracking-tight leading-tight", children: "We build surgical facilities from the ground up — concept to accreditation, in every province, for every type of surgical practice." }),
          /* @__PURE__ */ jsx("p", { className: "mt-6 text-muted-foreground text-lg leading-relaxed max-w-4xl mx-auto", children: "Opening a non-hospital surgical facility in Canada is one of the most regulated, capital-intensive, and operationally complex undertakings in private healthcare. Every province has its own regulatory body, its own accreditation standards, and its own approach to publicly funded contracting. Vitalis provides end-to-end advisory for surgical facility builds, regulatory navigation, accreditation preparation, and ongoing operational optimization — for medical, dental, and veterinary surgical practices across Canada." })
        ] }),
        /* @__PURE__ */ jsx(motion.div, { ...fadeUp, transition: { duration: 0.6, delay: 0.15 }, className: "mt-12 grid md:grid-cols-3 gap-4", children: hooks.map((h, i) => /* @__PURE__ */ jsx("div", { className: "bg-accent/10 border border-accent/30 rounded-xl p-5 text-left", children: /* @__PURE__ */ jsx("p", { className: "text-sm text-foreground leading-relaxed", children: h }) }, i)) }),
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, transition: { duration: 0.6, delay: 0.25 }, className: "flex flex-col sm:flex-row gap-4 justify-center mt-10", children: [
          /* @__PURE__ */ jsx(Button, { variant: "hero", size: "lg", asChild: true, children: /* @__PURE__ */ jsxs(Link, { to: "/contact", children: [
            "Book a Surgical Facility Consultation ",
            /* @__PURE__ */ jsx(ArrowRight, { className: "ml-1 h-4 w-4" })
          ] }) }),
          /* @__PURE__ */ jsx(Button, { variant: "hero-outline", size: "lg", asChild: true, children: /* @__PURE__ */ jsx(Link, { to: "/strategic-assessment", children: "Start With an Assessment" }) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 lg:px-8 max-w-6xl", children: [
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, className: "text-center mb-14", children: [
          /* @__PURE__ */ jsx("h2", { className: "font-display text-2xl lg:text-3xl font-bold text-foreground", children: "End-to-end advisory — from the first conversation to ongoing operations." }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-3 max-w-2xl mx-auto", children: "Every stage of the surgical facility lifecycle. Every province. Every surgical specialty." })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: services.map((s, i) => {
          const Icon = s.icon;
          return /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, transition: { duration: 0.6, delay: i * 0.06 }, className: "bg-card rounded-2xl p-6 shadow-card border border-border/40 flex flex-col", children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-lg bg-secondary flex items-center justify-center mb-4", children: /* @__PURE__ */ jsx(Icon, { className: "h-5 w-5 text-primary" }) }),
            /* @__PURE__ */ jsx("h3", { className: "font-display text-base font-bold text-foreground mb-2", children: s.label }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: s.body })
          ] }, i);
        }) })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-24 lg:py-32 bg-gradient-section", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 lg:px-8 max-w-5xl", children: [
        /* @__PURE__ */ jsx(motion.div, { ...fadeUp, className: "text-center mb-10", children: /* @__PURE__ */ jsx("h2", { className: "font-display text-2xl lg:text-3xl font-bold text-foreground", children: "Non-Hospital Surgical Facilities in Canada — what they are and why they matter." }) }),
        /* @__PURE__ */ jsx(motion.p, { ...fadeUp, className: "text-muted-foreground leading-relaxed mb-12 max-w-4xl mx-auto", children: "A Non-Hospital Surgical Facility is any facility outside a public hospital that performs designated surgical or procedural services. In Canada, these facilities operate under provincial regulatory frameworks that delegate accreditation authority to the provincial College of Physicians and Surgeons — or in some provinces, to designated national bodies. Every province that permits NHSFs requires accreditation before a facility can treat patients. Every province has its own standards, its own inspection process, and its own approach to publicly funded contracting. There is no single national framework — understanding the province-by-province landscape is foundational to planning a surgical facility anywhere in Canada." }),
        /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-8", children: [
          /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, className: "bg-card rounded-2xl p-8 shadow-card border border-border/40", children: [
            /* @__PURE__ */ jsx("h3", { className: "font-display text-lg font-bold text-foreground mb-3", children: "What NHSFs Do" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "NHSFs perform surgical and procedural services that do not require the full resources of a public hospital — ophthalmology, orthopedics, dermatology, plastics, gynecology, ENT, oral surgery, pain management, and other specialties. They can be physician-owned, corporate-owned, or structured as public-private partnerships. They may serve entirely private-pay patients, or may contract with provincial health authorities to deliver publicly funded procedures." })
          ] }),
          /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, transition: { duration: 0.6, delay: 0.1 }, className: "bg-card rounded-2xl p-8 shadow-card border border-border/40", children: [
            /* @__PURE__ */ jsx("h3", { className: "font-display text-lg font-bold text-foreground mb-3", children: "Why They Exist" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "NHSFs emerged across Canada as a mechanism to increase surgical capacity, reduce hospital wait times, and provide a more focused patient experience for certain procedure types. Alberta's Alberta Surgical Initiative, Ontario's community surgical centre expansion, and BC's long-standing NHMSFAP program all reflect provincial recognition that well-regulated private surgical facilities play a legitimate role in the healthcare system. In 2024-25, Alberta alone budgeted for 60,000-65,000 publicly funded procedures to be performed in chartered surgical facilities." })
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 lg:px-8 max-w-5xl", children: [
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, className: "text-center mb-6", children: [
          /* @__PURE__ */ jsx("h2", { className: "font-display text-2xl lg:text-3xl font-bold text-foreground", children: "Every province is different. Here is what surgical facility accreditation looks like across Canada." }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-3 max-w-3xl mx-auto", children: "Vitalis has working knowledge of the regulatory framework in every province where we operate. This section outlines the key accreditation body and framework for each major province." })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "space-y-6 mt-14", children: provinces.map((p, i) => /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, transition: { duration: 0.6, delay: i * 0.08 }, className: "bg-card rounded-2xl p-6 lg:p-8 shadow-card border-l-4 border-primary", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsx(MapPin, { className: "h-5 w-5 text-primary shrink-0" }),
            /* @__PURE__ */ jsx("h3", { className: "font-display text-lg font-bold text-foreground", children: p.province })
          ] }),
          p.body && /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-foreground mb-1", children: p.body }),
          p.framework && /* @__PURE__ */ jsxs("p", { className: "text-xs text-muted-foreground mb-3", children: [
            /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Framework:" }),
            " ",
            p.framework
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-3", children: p.context }),
          p.note && /* @__PURE__ */ jsx("p", { className: "text-sm text-primary font-medium italic", children: p.note })
        ] }, i)) })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-24 lg:py-32 bg-gradient-section", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 lg:px-8 max-w-6xl", children: [
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, className: "text-center mb-14", children: [
          /* @__PURE__ */ jsx("h2", { className: "font-display text-2xl lg:text-3xl font-bold text-foreground", children: "Surgical procedures performed in NHSFs across Canada." }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-3 max-w-3xl mx-auto", children: "The approved procedure list varies by province and evolves over time. The following are the core categories that appear across most provincial frameworks." })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-5", children: procedures.map((p, i) => {
          const Icon = p.icon;
          return /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, transition: { duration: 0.6, delay: i * 0.05 }, className: "bg-card rounded-2xl p-5 shadow-card border border-border/40", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-lg bg-secondary flex items-center justify-center mb-3", children: /* @__PURE__ */ jsx(Icon, { className: "h-4 w-4 text-primary" }) }),
            /* @__PURE__ */ jsx("h3", { className: "font-display text-sm font-bold text-foreground mb-1", children: p.label }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-xs leading-relaxed", children: p.desc })
          ] }, i);
        }) })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 lg:px-8 max-w-4xl", children: [
        /* @__PURE__ */ jsx(motion.h2, { ...fadeUp, className: "font-display text-2xl lg:text-3xl font-bold text-foreground text-center mb-14", children: "How Vitalis builds a surgical facility — from first conversation to first patient." }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-8 relative", children: [
          /* @__PURE__ */ jsx("div", { className: "hidden md:block absolute left-6 top-8 bottom-8 w-px bg-primary/20" }),
          buildSteps.map((s, i) => {
            const Icon = s.icon;
            return /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, transition: { duration: 0.6, delay: i * 0.08 }, className: "flex gap-6 relative", children: [
              /* @__PURE__ */ jsx("div", { className: "shrink-0 w-12 h-12 rounded-xl bg-primary/10 border-2 border-primary/30 flex items-center justify-center z-10", children: /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-primary", children: s.num }) }),
              /* @__PURE__ */ jsxs("div", { className: "bg-card rounded-2xl p-6 shadow-card border border-border/40 flex-1", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                  /* @__PURE__ */ jsx(Icon, { className: "h-4 w-4 text-primary" }),
                  /* @__PURE__ */ jsx("h3", { className: "font-display text-base font-bold text-foreground", children: s.heading })
                ] }),
                /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: s.body })
              ] })
            ] }, i);
      ...
      /* @__PURE__ */ jsx("section", { className: "py-24 lg:py-32 bg-gradient-section", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 lg:px-8 max-w-6xl", children: [
        /* @__PURE__ */ jsx(motion.h2, { ...fadeUp, className: "font-display text-2xl lg:text-3xl font-bold text-foreground text-center mb-14", children: "Surgical facility types Vitalis works with." }),
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-8", children: facilityTypes.map((f, i) => {
          const Icon = f.icon;
          return /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, transition: { duration: 0.6, delay: i * 0.1 }, className: "bg-card rounded-2xl p-8 shadow-card border border-border/40 flex flex-col", children: [
            /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-xl bg-secondary flex items-center justify-center mb-6", children: /* @__PURE__ */ jsx(Icon, { className: "h-6 w-6 text-primary" }) }),
            /* @__PURE__ */ jsx("h3", { className: "font-display text-lg font-bold text-foreground mb-3", children: f.label }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm leading-relaxed flex-1 mb-6", children: f.body }),
            /* @__PURE__ */ jsx(Button, { variant: "hero-outline", size: "default", asChild: true, className: "w-full whitespace-normal h-auto py-3 text-center leading-snug", children: /* @__PURE__ */ jsxs(Link, { to: f.href, children: [
              f.cta,
              " ",
              /* @__PURE__ */ jsx(ArrowRight, { className: "ml-1 h-4 w-4 shrink-0" })
            ] }) })
          ] }, i);
        }) })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 lg:px-8 max-w-5xl", children: [
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, className: "text-center mb-6", children: [
          /* @__PURE__ */ jsx("h2", { className: "font-display text-2xl lg:text-3xl font-bold text-foreground", children: "The surgical facility financial model — the part most surgeons don't fully understand before they build." }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mt-3 max-w-3xl mx-auto", children: "Surgical facilities in Canada that contract with provincial health authorities operate under a dual revenue structure that is fundamentally different from a medical clinic. Understanding this structure is not optional — it determines whether your facility is financially viable." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-8 mt-14", children: [
          /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, className: "bg-card rounded-2xl p-8 shadow-card border border-primary/20", children: [
            /* @__PURE__ */ jsx("h3", { className: "font-display text-lg font-bold text-foreground mb-3", children: "Provincial Health Authority Facility Fee" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: "When a surgical facility contracts with a provincial health authority (AHS in Alberta, HIBC in BC, etc.) to perform publicly funded procedures, it receives a facility fee for each procedure. This fee is intended to cover operational costs — space, nursing staff, surgical supplies, utilities, equipment amortization, and administrative overhead. It is not a profit margin. Profitability comes from operating efficiently within the fee structure." }),
            /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: ["Fee rates are set by the health authority, not the facility", "Rates vary by procedure type and province", "The fee covers facility costs only — not physician fees", "Facility fee revenue requires meeting accreditation and contracting standards"].map((t, i) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2 text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsx(CheckCircle, { className: "h-4 w-4 text-primary mt-0.5 shrink-0" }),
              t
            ] }, i)) })
          ] }),
          /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, transition: { duration: 0.6, delay: 0.1 }, className: "bg-card rounded-2xl p-8 shadow-card border border-accent/30", children: [
            /* @__PURE__ */ jsx("h3", { className: "font-display text-lg font-bold text-foreground mb-3", children: "Physician Fee-for-Service (Separate)" }),
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: "Surgeons performing procedures in NHSFs bill their provincial health insurance plan (AHCIP in Alberta, MSP in BC, OHIP in Ontario) directly for physician services — at the same fee schedule rates as hospital procedures. Anesthesiologists bill separately. These payments go to the physician, not the facility." }),
            /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: ["Physician income and facility revenue are financially independent", "Both streams must be modeled separately", "A facility can be profitable while a physician loses money, or vice versa", "New NHSF operators frequently confuse these two streams in their financial models"].map((t, i) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2 text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsx(CheckCircle, { className: "h-4 w-4 text-accent mt-0.5 shrink-0" }),
              t
            ] }, i)) })
          ] })
        ] }),
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, transition: { duration: 0.6, delay: 0.2 }, className: "bg-accent/10 border border-accent/30 rounded-2xl p-8 mt-8", children: [
          /* @__PURE__ */ jsx("h3", { className: "font-display text-lg font-bold text-foreground mb-3", children: "Private Pay Revenue" }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "NHSFs may also perform private-pay procedures — services not covered by provincial health insurance or health authority contracts. Cosmetic surgery, elective procedures for international patients, and certain uninsured services can generate private-pay revenue. Private pay has no facility fee ceiling — the facility sets its own pricing. The same accreditation standards apply regardless of payer." })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-24 lg:py-32 bg-gradient-section", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 lg:px-8 max-w-4xl", children: [
        /* @__PURE__ */ jsx(motion.h2, { ...fadeUp, className: "font-display text-2xl lg:text-3xl font-bold text-foreground text-center mb-14", children: "The most common reasons surgical facility builds stall, fail, or significantly overspend — and what Vitalis does to prevent each one." }),
        /* @__PURE__ */ jsx("div", { className: "space-y-6", children: failurePoints.map((f, i) => /* @__PURE__ */ jsx(motion.div, { ...fadeUp, transition: { duration: 0.6, delay: i * 0.08 }, className: `rounded-2xl p-6 lg:p-8 border border-border/40 ${i % 2 === 0 ? "bg-card" : "bg-card/60"}`, children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxs("span", { className: "text-2xl font-bold text-primary/30 font-display shrink-0", children: [
            "0",
            i + 1
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("p", { className: "text-sm font-semibold text-foreground mb-2", children: [
              /* @__PURE__ */ jsx("span", { className: "text-destructive", children: "Problem:" }),
              " ",
              f.problem
            ] }),
            /* @__PURE__ */ jsxs("p", { className: "text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsx("span", { className: "font-semibold text-primary", children: "Vitalis:" }),
              " ",
              f.solution
            ] })
          ] })
      ...
      /* @__PURE__ */ jsx("section", { className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 lg:px-8 max-w-6xl", children: [
        /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, className: "text-center mb-14", children: [
          /* @__PURE__ */ jsx("h2", { className: "font-display text-2xl lg:text-3xl font-bold text-foreground", children: "Surgical facility engagements — a sample." }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm mt-2", children: "Client details withheld." })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-6", children: cases.map((c, i) => /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, transition: { duration: 0.6, delay: i * 0.1 }, className: "bg-card rounded-2xl p-6 shadow-card border border-border/40", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold uppercase tracking-wider text-accent", children: c.tag }),
          /* @__PURE__ */ jsx("h3", { className: "font-display text-lg font-bold text-foreground mt-3 mb-2", children: c.headline }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: c.body })
        ] }, i)) })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-20 lg:py-28 bg-forest-dark", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 lg:px-8 max-w-3xl text-center", children: /* @__PURE__ */ jsxs(motion.div, { ...fadeUp, children: [
        /* @__PURE__ */ jsx("h2", { className: "font-display text-2xl lg:text-3xl font-bold text-primary-foreground tracking-tight", children: "A surgical facility is not a clinic with an OR. It is one of the most complex investments in private healthcare — and one of the most rewarding when it is built correctly." }),
        /* @__PURE__ */ jsx("p", { className: "text-primary-foreground/70 mt-4 text-lg", children: "Vitalis provides the advisory experience to do it right — from the first feasibility conversation through accreditation and into long-term operations. We have done this across provinces, across specialties, and across facility types. We know exactly where the process breaks down and how to prevent it." }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center mt-8", children: [
          /* @__PURE__ */ jsx(Button, { variant: "hero", size: "lg", asChild: true, className: "whitespace-normal h-auto py-3 text-center leading-snug", children: /* @__PURE__ */ jsxs(Link, { to: "/contact", children: [
            "Book a Surgical Facility Consultation ",
            /* @__PURE__ */ jsx(ArrowRight, { className: "ml-1 h-4 w-4 shrink-0" })
          ] }) }),
          /* @__PURE__ */ jsx(Button, { variant: "hero-outline", size: "lg", asChild: true, className: "border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10", children: /* @__PURE__ */ jsx(Link, { to: "/strategic-assessment", children: "Start With an Assessment" }) })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-primary-foreground/50 text-sm mt-8", children: "Vitalis works with surgical facilities across Alberta, British Columbia, Saskatchewan, Manitoba, Ontario, and other Canadian provinces. Contact us to discuss your province and procedure scope." })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsx(Footer, {})
  ] });
