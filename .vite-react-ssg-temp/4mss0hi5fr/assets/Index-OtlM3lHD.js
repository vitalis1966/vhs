...
import { S as SEOHead } from "./SEOHead-DZvfQKbW.js";
...
const Footer = lazy(() => import("./Footer-vLUE6RrN.js").then((m) => ({ default: m.Footer })));
const PracticePathFinder = lazy(() => import("./PracticePathFinder-DQnr4nC2.js").then((m) => ({ default: m.PracticePathFinder })));
const ImpactStatsSection = lazy(() => import("./ImpactStatsSection-DLRQH1Bm.js").then((m) => ({ default: m.ImpactStatsSection })));
const WhatWeDoSection = lazy(() => import("./WhatWeDoSection-BmS4e8qW.js").then((m) => ({ default: m.WhatWeDoSection })));
const CredibilitySection = lazy(() => import("./CredibilitySection-DYwQPIxX.js").then((m) => ({ default: m.CredibilitySection })));
const FinalCtaSection = lazy(() => import("./FinalCtaSection-DHUGpak0.js").then((m) => ({ default: m.FinalCtaSection })));
const Index = () => {
  usePageMeta(
